...
export default async (client, interaction) => {
    ...
    fs.readFile(`${__dirname}/cache/embeds/${embedName}.json`, (err, file) => {
        ...
        data.embed.author && data.embed.author.name && data.embed.author.iconURL && data.embed.author.url && validate(data.embed.author.iconURL, 'url') && validate(data.embed.author.url, 'url') ? embed.setAuthor({name: data.embed.author.name, url: data.embed.author.url, iconURL: data.embed.author.iconURL}) : null;
